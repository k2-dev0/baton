...
export const protocol = {
  definitions: {
    ...
    v2: {
      ...
      TurnStartParams: object({ threadId: string, input: array({}), model: string,
        effort: { anyOf: [ref("ReasoningEffort"), { type: "null" }] },
        summary: { anyOf: [ref("ReasoningSummary"), { type: "null" }] },
        personality: { anyOf: [ref("Personality"), { type: "null" }] },
        serviceTier: { type: ["string", "null"] }, serviceTierForTurn: { type: ["string", "null"] },
        responsesapiClientMetadata: { type: ["object", "null"], additionalProperties: string }, outputSchema: {},
        collaborationMode: collaboration, toolOutput: { anyOf: [ref("TurnToolOutput"), { type: "null" }] }, turnTrigger: string }, ["threadId", "input"]),
      ReasoningEffort: { type: "string", enum: ["none", "minimal", "low", "medium", "high", "xhigh", "max", "ultra"] },
      ReasoningSummary: { type: "string", enum: ["auto", "concise", "detailed", "none"] },
      Personality: { type: "string", enum: ["none", "friendly", "pragmatic"] },
